...
export ALTERNATE_EDITOR ANSIBLE_CONFIG BASH_SILENCE_DEPRECATION_WARNING   \
       BASH_ENV CLICOLOR CVS_RSH EDITOR HISTCONTROL HISTFILE HISTFILESIZE \
       HISTIGNORE HISTSIZE LANG LESS PATH XDG_CACHE_HOME XDG_CONFIG_HOME  \
